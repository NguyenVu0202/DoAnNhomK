...
class ProductController extends Controller
{
    ...
    public function indexAddProduct(){
        $category = Category::all();
        $manufacturer = Manufacturer::all();
        return view('admin.product.addproduct', ['categorys' => $category],['manufacturers' => $manufacturer]);
    }
    ...
    public function indexUpdateProduct(Request $request){
        ...
        $category = Category::all();
        $manufacturer = Manufacturer::all();
        return view('admin.product.updateproduct', ['products' => $product],['categorys' => $category,'manufacturers' => $manufacturer]);
    }
    public function updateProduct(Request $request){
        ...
        {
            //Xoa ảnh cũ
            $image_cu = 'uploads/productimage/' . $product->image;
