                    ...
                    <div class="col-md-4 clearfix">
                        <div class="header-ctn">
                            ...
                            <!-- /Cart -->
                              ...
                              <!-- Cart -->
                              <div class="dropdown">
                                <a class="dropdown-toggle" href="{{ route('order.orderIndex') }}">
                                    <i class="fa fa-shopping-cart"></i>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-xs-6">
                    <div class="manufacturer" style=" border-radius: 1px solid black;">
                        <img src="{{ asset('uploads/manufacturerimage/' . $manufacturer->image_manufacturer) }}" alt=""
                    ...
                    <div class="section-title">
                        ...
                        <div class="section-nav">
							...
							<li class="active"><a data-toggle="tab" href="#">All</a></li>
                                ...
                                <li><a data-toggle="tab" href="#">{{ $category->name_category }}</a></li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
